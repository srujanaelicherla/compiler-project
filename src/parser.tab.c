...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ID = 9,                         /* ID  */
  YYSYMBOL_INT_LITERAL = 10,               /* INT_LITERAL  */
  YYSYMBOL_FLOAT_LITERAL = 11,             /* FLOAT_LITERAL  */
...
static const char *const yytname[] =
{
  ...
  "ELSE", "WHILE", "PRINT", "ID", "INT_LITERAL", "FLOAT_LITERAL", "PLUS",
  "MINUS", "MULT", "DIV", "ASSIGN", "SEMICOLON", "$accept", "program",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* statement: PRINT SEMICOLON  */
#line 24 "src/parser.y"
                    { printf("Parsed a print statement!\n"); }
#line 1077 "src/parser.tab.c"
    break;


#line 1081 "src/parser.tab.c"
